...
public:
  ...
  bool is_stable_;
  jsk_recognition_msgs::BoundingBox object_;
  std::string label_;
  ...
  void updateMeasurementForCTRV(const std::vector<jsk_recognition_msgs::BoundingBox>& object_vec);

  void uppateForCTRV();

  void updateEachMotion(const double detection_probability, const double gate_probability, const double gating_thres,
                        const std::vector<jsk_recognition_msgs::BoundingBox>& object_vec, std::vector<double>& lambda_vec);

  void updateSUKF(const std::vector<jsk_recognition_msgs::BoundingBox>& object_vec);
  ...
  void checkLaneDirectionAvailability(const jsk_recognition_msgs::BoundingBox& in_object,
  ...
  double calculateNIS(const jsk_recognition_msgs::BoundingBox& in_object, const int motion_ind);

  bool isLaneDirectionAvailable(const jsk_recognition_msgs::BoundingBox& in_object, const int motion_ind,
